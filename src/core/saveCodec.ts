...
const assertSupportedV2 = (parsed: Record<string, unknown>, rawPet: Record<string, unknown>) => {
  ...
  const supportedModules: Record<string, number> = { garden: 5, goldenAppleGacha: 4, partnerSchedule: 6, boostCards: 2, classicEndgame: 2, timeGuard: 1, kitchen: 1, miniGames: 1, companionMemories: 1 };
