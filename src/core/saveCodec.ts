...
const assertSupportedModuleVersions = (rawPet: Record<string, unknown>) => {
  const supportedModules: Record<string, number> = { garden: 6, goldenAppleGacha: 4, partnerSchedule: 7, boostCards: 2, classicEndgame: 2, timeGuard: 1, timePause: 1, kitchen: 1, miniGames: 1, companionMemories: 1, festivalStories: 3, adventure: 7, community: 10 };
