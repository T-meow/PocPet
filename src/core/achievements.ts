...
const baseAchievementDefinitionConfigs: readonly Omit<AchievementDefinition, 'title' | 'description'>[] = [
  ...
  { id: 'schedule_daily_three', category: 'hidden', rarity: 'hidden', target: 3, progress: (pet) => pet.partnerSchedule.dailyCompletedCount, reward: { coins: 500, partnerScheduleExtraRewardChancePercent: 10 }, hiddenUntilUnlocked: true },
