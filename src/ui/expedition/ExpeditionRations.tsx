...
export const ExpeditionRations = ({ pet, region, hours, selection, finds, showHelp = true }: { pet: PetState; region: RegionId; hours: number; selection: RationSelection; finds?: Inventory; showHelp?: boolean }) => {
  ...
  return <div className="exp-rations">
    <div className="help-heading"><strong>{q.reason || '补给已备齐'} · {q.count}/{q.maximum} 份</strong>{showHelp && <HelpButton {...getRationsHelp(q)} />}</div>
