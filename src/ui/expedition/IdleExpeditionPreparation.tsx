...
export const IdleExpeditionPreparation = ({ pet, actorId, actorName, update, registry, icons, onUseHomeItem, onShop, initialRegion, initialTarget, onMap, onCamp, onRoute, embedded }: ExpeditionProps & PreparationResources & {
  ...
  return <>
    ...
    <PreparationInventory pet={pet} registry={registry} icons={icons} bag={rations.food} capacity={q.maximum} automaticFood={q.purchased ? { trail_mix: q.purchased } : {}} foodOnly onPack={changeFood} onUseHomeItem={onUseHomeItem} perform={perform} bagHeadingExtra={<ExplorationBackpackUpgrade compact pet={pet} update={update} />} bagExtra={<>
