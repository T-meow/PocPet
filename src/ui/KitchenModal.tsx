...
import { activityText as L, cookingMethods, dishName, getDish, getDishId, getRecipe, getRecipeEffect, getRecipeIngredientEntries, getRecipeUnlockReason, recipeName, recipes } from '../core/kitchenRecipes';
