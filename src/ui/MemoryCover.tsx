...
export const MemoryCover = ({ days, image, unlocked, hasReward = false, onOpen }: { days: number; image: string; unlocked: boolean; hasReward?: boolean; onOpen: () => void }) => <button className="memory-cover" onClick={onOpen}>
  <ClaimNotice show={hasReward} />
