...
interface Props extends PreparationResources {
  pet: PetState; bag: Inventory; destination?: AdventureDestinationId; purpose?: CommunityRoute; embedded?: boolean;
...
export const AdventurePreparation = ({ pet, registry, icons, bag, destination, purpose, onPack, onDepart, onClose, onUseHomeItem, perform, update, embedded }: Props) => {
  ...
  const contents = <>
    ...
    <PreparationInventory pet={pet} registry={registry} icons={icons} bag={bag} capacity={capacity} onPack={onPack} onUseHomeItem={onUseHomeItem} perform={perform} bagHeadingExtra={update && <ExplorationBackpackUpgrade compact pet={pet} update={update} />} />
