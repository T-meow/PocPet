...
当前有效标准：用户已明确指定 [2026-09-14 站立三视图](../output/imagegen/furo-standing-turnaround-20260914/standing-turnaround-raw.png) 为后续 Furo 角色图标准。按每批三张原图生成并交用户检查，尚未授权加工或接入。下文保留各阶段历史记录。
